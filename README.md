...
если проект собран под старую версию и уже много добавленных виджетов, то можно воспользоваться этим регулярным выражением в VS Code для быстрой замены 
